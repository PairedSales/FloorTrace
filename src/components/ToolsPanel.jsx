import { Ruler, Pentagon, Eraser, Crop, RotateCw, Compass, Spline, SquareDashedBottom } from 'lucide-react';
    ...
    <div className="flex shrink-0 flex-col animate-slide-in-left border-r border-b border-chrome-700 bg-chrome-800 rounded-br-xl pointer-events-none select-none">
      <section className="px-3 py-3 pointer-events-auto">
        ...
        <div className="grid grid-cols-2 gap-1.5">
          ...
          {/* Punch a void out of a trace: drag a rectangle, or click corner by
              corner and close on the first one. */}
          {hasArea && (
            <button
