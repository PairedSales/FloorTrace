...
const EXTERIOR_FEATURE_RE =
  /\b(garages?|porch(?:es)?|patios?|decks?|sun\s?decks?|balcon(?:y|ies)|terraces?|veranda[hs]?|lanais?|stoops?|breezeways?|carports?|pergolas?|gazebos?|porticos?|courtyards?)\b/i;
